...
func SetupRoutes(dbConn database.Database, rdb *redis.Client) *mux.Router {
	...
	log.Println("[PACIENTI] Routes setup completed.")
	return router
}
...
func loadCrudRoutes(router *mux.Router, pacientController *controllers.PacientController) {
	log.Println("[PACIENTI] Loading CRUD routes for Pacient entity...")
	...
	log.Println("[PACIENTI] Route POST /pacienti registered.")
	...
	log.Println("[PACIENTI] Route GET /pacienti registered.")
	...
	log.Println("[PACIENTI] Route GET /pacienti/{id} registered.")
	...
	log.Println("[PACIENTI] Route GET /pacienti/email/{email} registered.")
	...
	log.Println("[PACIENTI] Route GET /pacienti/users/{id} registered.")
	...
	log.Println("[PACIENTI] Route PUT /pacienti/{id} registered.")
	...
	log.Println("[PACIENTI] Route DELETE /pacienti/{id} registered.")

	log.Println("[PACIENTI] All CRUD routes for Pacient entity loaded successfully.")
}
