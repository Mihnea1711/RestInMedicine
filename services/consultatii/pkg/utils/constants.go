...
const (
	...
	FETCH_CONSULTATIE_BY_DOCTOR_ID_ENDPOINT  = "/consultations/doctor/{" + FETCH_CONSULTATIE_BY_DOCTOR_ID_PARAMETER + "}"
	FETCH_CONSULTATIE_BY_DOCTOR_ID_PARAMETER = "id_doctor"

	FETCH_CONSULTATIE_BY_PACIENT_ID_ENDPOINT  = "/consultations/pacient/{" + FETCH_CONSULTATIE_BY_PACIENT_ID_PARAMETER + "}"
