...
const (
	...
	UPDATE_CONSULTATIE_BY_ID_ENDPOINT  = "/consultatii/{" + FETCH_CONSULTATIE_BY_DATE_PARAMETER + "}"
	UPDATE_CONSULTATIE_BY_ID_PARAMETER = "id_consultatie"

	DELETE_CONSULTATIE_BY_ID_ENDPOINT  = "/consultatii/{" + FETCH_CONSULTATIE_BY_DATE_PARAMETER + "}"
