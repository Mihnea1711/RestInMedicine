...
const (
	...
	GET_APPOINTMENTS_BY_PATIENT_ID_ENDPOINT = "/api/appointments/patients/{" + GET_APPOINTMENT_PATIENT_ID_PARAMETER + "}"
	...
	GET_APPOINTMENT_PATIENT_ID_PARAMETER = "patientID"
	...
	APPOINTMENT_FETCH_APPOINTMENTS_BY_PATIENT_ID_ENDPOINT = "/appointments/patients"
...
const (
	...
	GET_CONSULTATION_BY_PATIENT_ID_ENDPOINT = "/api/consultations/patients/{" + GET_CONSULTATION_BY_PATIENT_ID_PARAMETER + "}"
	...
	GET_CONSULTATION_BY_PATIENT_ID_PARAMETER = "patientID"
	...
	CONSULTATION_FETCH_CONSULTATIE_BY_PATIENT_ID_ENDPOINT = "/consultations/patients"
