...
func loadDoctorRoutes(router *mux.Router, gatewayController *controllers.GatewayController) {
	...
	router.Handle(utils.CREATE_DOCTOR_ENDPOINT, doctorCreationHandler).Methods("POST") // Creates a new doctor
	...
	router.HandleFunc(utils.GET_ALL_DOCTORS_ENDPOINT, doctorFetchAllHandler).Methods("GET") // Lists all doctors
	...
	router.HandleFunc(utils.GET_DOCTOR_BY_ID_ENDPOINT, doctorFetchByIDHandler).Methods("GET") // Lists all doctors
	...
	router.Handle(utils.UPDATE_DOCTOR_BY_ID_ENDPOINT, doctorUpdateByIDHandler).Methods("PUT") // Updates a specific doctor
